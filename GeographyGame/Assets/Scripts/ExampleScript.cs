...
public class ExampleScript : MonoBehaviour
{
    ...
    void Awake()
    {
        ...
        cube1.transform.position = new Vector3(-1f, 0.0f, 0.0f);
        cube1.transform.Rotate(45.0f, 0.0f, 0.0f, Space.Self);
        cube1.GetComponent<Renderer>().material.color = Color.red;
        cube1.name = "Self";

        cube2 = GameObject.CreatePrimitive(PrimitiveType.Cube);
        cube2.transform.position = new Vector3(1f, 0.0f, 0.0f);
        cube2.transform.Rotate(45.0f, 0.0f, 0.0f, Space.World);
